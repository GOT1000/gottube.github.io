...
<!-- 에디터 컨테이너 시작 -->
		<div id="tx_trex_container" class="tx-editor-container" >
			...
			-->
			<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic" style="display:none;"><div class="tx-toolbar-boundary" style="display:none;">
			...
			<!-- 툴바 - 기본 끝 -->
			<!-- 툴바 - 더보기 시작 -->
			<div id="tx_toolbar_advanced" class="tx-toolbar tx-toolbar-advanced"><div class="tx-toolbar-boundary" style="display:none;">
				<ul class="tx-bar tx-bar-left">
					<li class="tx-list">
